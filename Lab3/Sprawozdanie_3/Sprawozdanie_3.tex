...
\section{Rozmyty PID}
W celu lepszej regulacji obiektu nieliniowego zosta³ zaimplementowany regulator rozmyty PID. W tym celu utworzono funkcje dzwonowe, które decydowa³y który regulator i w jakim stopniu ma wp³yw na wyjœcie.
...
Dzia³anie regulatora rozmytego przedstawiono na rys. \ref{PID_roz_lab}. Funkcje przynale¿noœci zastosowane w eksperymentach pokazano na rys. \ref{dzwon_lab}.
...
Wyniki eksperymentu przedstawiono na rys. \ref{DMC_roz_lab}. Funkcje przynale¿noœci zastosowane w eksperymentach pokazano na rys. \ref{dzwon_lab}.
...
\begin{figure}[!ht]
	\centering
	\input{../rysunki_tikz/funkcje_dzwonowe.tex}
	\caption{Funkcje dzwonowe wzglêdem których odbywa³o siê rozmywanie regulatorów lokalnych}
	\label{dzwon_lab}
\end{figure}
...
Jak widaæ z wykresów zarówno dla regulatora PID jak i DMC oddzielne strojenie ka¿dego z regulatorów lokalnych, pomimo ¿e czasoch³onne, pozwoli³o uzyskaæ lepsz¹ regulacje ni¿ w przypadku takich samych nastawów.
Taki wynik eksperymentu jest intuicyjny, gdy¿ regulator z takimi samymi parametrami regulatorów lokalnych zachowuje siê tak samo jak pojedynczy regulator liniowy. Szczególnie znacz¹ce okaza³a siê zmiana wartoœci $\lambda$ dla regulatora DMC. Pozwoli³o to regulatorom lokalnym na swobodniejszy dobór sterowania, co skutkowa³o lepsz¹ regulacj¹.
...
niewielkiej iloœci regulatorów lokalnych mo¿na by³o uzyskaæ zadowalaj¹ce wyniki regulacji.
Funkcje dzwonowe wzglêdem których dokonywane by³o rozmycie przedstawiono na rys \ref{dzwon_proj}.

\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_przyk_fun_przynal.pdf}
	\caption{Przyk³ad funkcji dzwonowych dla 3 regulatorów lokalnych, na podstawie których dokonywano rozmycia}
	\label{dzwon_proj}
\end{figure}
...
dlatego pozostano przy wartoœci wyznaczonej dla regulatora liniowego $\lambda = 50$.
