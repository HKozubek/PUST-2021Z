...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad4_6_test_normal_DMC.pdf}
...
Jako zmienn¹, na podstawie której dokonywane jest rozmywanie wybrano sterowanie "U".
Zmienna ta zosta³a wybrana na podstawie otrzymanej charakterystyki statycznej. Mo¿na 
zauwa¿yæ, ¿e dla sterowania przedzia³y, w których proces jest w przybli¿eniu liniowy
s¹ podobnej d³ugoœci. W porównaniu dla zmiennej wyjœcia proces charakteryzuje siê bardzo
ma³ym wzmocnieniem tylko dla $Y \in  <-0.32 0>$, natomiast du¿ym dla reszty wyjœæ($Y \in <0, 12>$).
Utrudni³oby to wybór funkcji wyznaczaj¹cej wspó³czynnik przynale¿noœci lub wymusi³o zastosowanie
wielu regulatorów lokalnych w celu uzyskania poprawy wyniku regulacji w porównaniu do
jednego regulatora.

\section{Liczba regulatorów lokalnych}
Nastawy regulatorów lokalnych lokalnych wybrano metod¹ eksperymentaln¹, w taki sposób aby uzyskaæ jak najlepsz¹ jakoœæ regulacji wokó³ punktu pracy danego regulatora. Na rys. \ref{PID_rozmyty_2} - rys. \ref{PID_rozmyty_5} pokazano jak dzia³a rozmyty regulator PID w zale¿noœci od liczby regulatorów lokalnych (od 2 do 5).
Na rys. \ref{DMC_rozmyty_2} - rys. \ref{DMC_rozmyty_5}, pokazano natomiast dzia³anie rozmytego regulatora DMC w zale¿noœci od liczby lokalnych regulatorów (od 2 do 5).

\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_test_PID_num_2.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_test_PID_num_3.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_test_PID_num_4.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_test_PID_num_5.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_test_DMC_num_2_lambda50.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_test_DMC_num_3_lambda50.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_test_DMC_num_4_lambda50.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.85]{../../Projekt3/rysunki_pdf/Zad5_test_DMC_num_5_lambda50.pdf}
