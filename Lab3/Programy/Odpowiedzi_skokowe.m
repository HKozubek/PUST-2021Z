...
subplot(2, 3, 6)
plot(jump80(609:929))
title('Skok sterowania: 70->80')
axis([0 320 jump80(609) jump80(609)+4.5])
ylabel("Temperatura [°C]")
xlabel("Czas [s]")

% matlab2tikz('../rysunki_tikz/v2_odpowiedzi_skokowe.tex', 'showInfo', false)
