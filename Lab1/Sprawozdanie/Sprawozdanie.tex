...
Z wykresów mo¿na wyczytaæ, ¿e zmiana parametrów PDI poprawi³a jakoœc regulacji. Co do regulatora DMC natomiast, to dzia³a on ca³kiem dobrze,
jednak zarówno PDI jak i DMC s¹ nara¿one na zak³ócenia które mo¿na zauwa¿yæ na wykresach.
...
% \begin{figure}[h]
% 	\centering
% 	\input{../../Projekt1/rysunki_tikz/test_DMC1.tex}
...
% \begin{figure}[h]
% 	\centering
% 	\input{../../Projekt1/rysunki_tikz/test_DMC2.tex}
...
% \begin{figure}[h]
% 	\centering
% 	\input{../../Projekt1/rysunki_tikz/test_DMC3.tex}
...
% \begin{figure}[h]
% 	\centering
% 	\input{../../Projekt1/rysunki_tikz/test_DMC4.tex}
...
% \begin{figure}[h]
% 	\centering
% 	\input{../../Projekt1/rysunki_tikz/test_DMC5.tex}
...
% \begin{figure}[h]
% 	\centering
% 	\input{../../Projekt1/rysunki_tikz/test_DMC6.tex}
