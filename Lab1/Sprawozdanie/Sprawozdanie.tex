...
algorytmów regulacji jednowymiarowego procesu na grzewczym stanowisku laboratoryjnym.
%Stanowsko grzewcze sk˜ada si˜ grza˜ki G1, wentylatora W1 oraz czujnika temperatury T1

\section{Przebieg laboratorium}
Przez ca³y czas trakcie trwania laboratorium moc wentylatora W1 powinna byæ
ustawiona 50\%.

\subsection{Zad 1}
W pierwszej kolejnoœci nale¿a³o odczytaæ wartoœæ temperatury odczytanej z 
termometru T1 w wyznaczonym punkcie pracy G1 = 26. Po ustawieniu mocy grza³ki
i odczekaniu, a¿ temperatura T1 ustabilizuje siê (rysunek), wartoœæ termometru T1 wynosi³a
\num{31.12} °C. 

\subsection{Zad 2}
W tej czœci laboratorium nale¿a³o przeprowadziæ eksperyment dla 3 rónych wartoœci mocy grza³ki G1.
Wartoœci G1 dla których zosta³y przeprowadzone eksperymenty to G1 = 36, G1 = 46 oraz G1 = 56. % TODO: ( rysunki)
