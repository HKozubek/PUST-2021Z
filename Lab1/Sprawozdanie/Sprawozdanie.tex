...
odczytana wartoœæ termometru T1 wynosi³a \num{31.12} °C. Wykres temperatury na termometrze T1 zosta³ przedstawiony na rys. % TODO:
...
dla trzech ró¿nych zmian sygna³u steruj¹cego, G1 = 36, G1 = 46 oraz G1 = 56. % TODO: ( rysunki)
Wykresy przedstawiaj¹ce zmiany temperatury przedstawiono odpowiednio na rys. rys. i rys. %TODO:
\begin{figure}[H]
\centering
...
\end{equation}
gdzie $S(i)$ - odpowiedŸ skokowa potrzebna do algorytmu DMC, $Y(i)$ - odpowiedŸ skokowa przed przekszta³ceniem. 
\end{document}
